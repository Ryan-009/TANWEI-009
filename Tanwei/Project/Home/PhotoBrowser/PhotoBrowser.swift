...
//  RedsMeMe
//
//  Created by rui chen on 2017/5/4.
...
public protocol PhotoBrowserDelegate {
    ...
    ///single tap
    func photoBrowserDidSinglePress(_ photoBrowser: PhotoBrowser)
}
...
public class PhotoBrowser: UIViewController {
    ...
    public override func viewDidAppear(_ animated: Bool) {
        ...
        if resId.components(separatedBy: ";").count >= 3 {
            addPhotoDetailIndicator()
        }
    ...
    private func addPhotoDetailIndicator() {
        ...
        indicator.snp.makeConstraints { (make) in
            ...
            make.leading.equalTo(screenWidth*0.6)
...
extension PhotoBrowser: UICollectionViewDelegate {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        if currentIndex == 2 && Int(offsetX / width) == 2 {
...
extension PhotoBrowser: PhotoBrowserCellDelegate {
    public func photoBrowserCellDidSingleTap(_ view: PhotoBrowserCell) {
        ...
        photoBrowserDelegate.photoBrowserDidSinglePress(self)
    }
