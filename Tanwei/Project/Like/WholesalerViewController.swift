//
//  WholesalerViewController.swift
//  Tanwei
//
...
class WholesalerViewController: UITableViewController {
    ...
    @objc private func loadData() {
        page = 0
        Application.list.focusGetFactory(start: page, limit: limit, success: {list in
