    ...
    func addImages() -> Void {
        ...
        for i in 0..<imageArray.count {
            ...
            if i == imageArray.count - 1 {
                ...
                let startButton = UIButton.init(frame: CGRect.init(x: HHScreenWidth*0.2, y: HHScreenHeight*0.85, width: HHScreenWidth*0.6, height: 50))
                startButton.setTitle("开始体验", for: .normal)
                startButton.setTitleColor(UIColor.white, for: .normal)
                startButton.backgroundColor = APPSubjectColor
